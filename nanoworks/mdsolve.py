...
def _write_lammps_input(
    ...
    temperature_damp_fs = float(temperature_damp)
    ...
    temperature_damp_ps = temperature_damp_fs / 1000.0

    total_steps = int(md_cycles) * int(md_steps_per_cycle)
    ...
    lines = [
        ...
        *mass_lines,
        ...
        (
            ...
            f'{temperature:.8f} {int(random_seed)} '
...
def _run_md_engine(
    ...
    if engine == 'LAMMPS':
        ...
        input_file = _write_lammps_input(
            ...
            timestep=timestep_profile[0],
            temperature_damp=temperature_damp_profile[0],
